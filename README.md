...
- **Sincronização com Google Sheets**: A tabela "Pardini" é consumida e sincronizada em tempo real via API do Google Sheets, permitindo edições, adições e exclusões diretamente pela interface.
...
- `/app`: Páginas principais da aplicação, incluindo a interface da Tabela Particular e os orçamentos da tabela Pardini.
